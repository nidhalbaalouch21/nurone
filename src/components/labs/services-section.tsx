import { Map, Zap, Package } from "lucide-react";
...
const services = [
  {
    ...
    title: "Blueprint",
    description:
      "We turn your idea into a product that can be built: users, core flows, roadmap, and the shortest path to value.",
    tags: ["Strategy", "UX Flows", "Roadmap"],
  },
  {
    icon: <Zap className="size-6 text-primary" />,
    title: "72h Prototype Sprint",
    description:
      "We make the opportunity visible before you invest deeper. In 72h, we turn your idea or expertise into a clickable prototype that shows the product, the flow, and the business potential.",
    tags: ["Figma", "Clickable", "Test Ready"],
  },
  {
    icon: <Package className="size-6 text-primary" />,
    title: "MVP Build",
    description:
      "We build the first serious product. Real screens, real workflows, launch-ready — built to handle real users, clients, and investors.",
    tags: ["React", "Node", "AI", "Cloud"],
  },
];
    ...
    <section className="relative z-10 w-full max-w-6xl mx-auto px-6 py-24 text-center">
      ...
      <ScrollReveal delay={0.2}>
        <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed mb-16 font-libra">
          We take the idea, prototype, or MVP and turn it into a working product — strategy,
          UX, architecture, build, and launch in one focused process. No wasted motion. No wrong team.
        </p>
      </ScrollReveal>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
        {services.map((service, i) => (
          <ScrollReveal key={service.title} delay={0.15 * i} className="h-full">
