  ...
  const cards = [
    {
      ...
      description:
        "We build and rebuild products with the architecture, code quality, and delivery discipline needed to scale.",
    },
    {
      icon: <Bot className="size-6 text-primary" />,
      title: "Agentic Operations",
      description:
        "We combine AI systems, automations, and expert operators to remove bottlenecks and accelerate execution.",
    },
    {
      icon: <Network className="size-6 text-primary" />,
      title: "Growth Infrastructure",
      description:
        "We turn positioning, outbound, inbound, and ads into repeatable systems for leads, pipeline, and revenue.",
    },
  ];
    ...
    >
      ...
      <ScrollReveal delay={0.2}>
        <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed mb-16 font-libra">
          Built for founders who want speed, technical depth, AI leverage, and
          revenue growth in one team.
        </p>
      </ScrollReveal>
        ...
        {cards.map((card, i) => (
          <ScrollReveal key={i} delay={0.15 * i} className="h-full">
            <CardSpotlight className="h-full flex flex-col items-center text-center p-8 border border-white/5 bg-[#0a0a0b]/60 backdrop-blur-sm shadow-[0_4px_30px_rgba(0,0,0,0.2)] rounded-3xl">
              ...
              <div className="relative mx-auto flex items-center justify-center size-14 rounded-full bg-primary/10 border border-primary/20 mb-6 shadow-[0_0_20px_rgba(37,99,235,0.15)]">
